...
import { StyledText, StyledTouchableOpacity, StyledView, StyledTouchableWithoutFeedback } from './StyledComponents';
                ...
                <GestureHandlerRootView style={{ flex: 1 }}>
                    ...
                    >
                        <StyledView className='p-6 items-center justify-between  w-max h-full'>
                            <StyledText className='text-[#204F50] font-poppi-bold text-xl'>{t("attributes.chooseDateOfBirth")}</StyledText>
                            ...
                            <StyledTouchableOpacity onPress={() => {
                                ...
                                <StyledText className='text-[#204F50] font-poppi-semibold text-base'>{t("attributes.save")}</StyledText>
