            ...
            <GestureHandlerRootView style={{ flex: 1 }}>
                ...
                >
                    <StyledView className='p-6 items-center justify-between  w-max h-full'>
                        <StyledText className='text-[#204F50] font-poppi-bold text-xl'>Choose date of birth</StyledText>
                        ...
                        <StyledTouchableOpacity onPress={() => {
                            ...
                            <StyledText className='text-[#204F50] font-poppi-semibold text-base'>Save</StyledText>
