...
const AddCard = () => {
    ...
    return (
        <StyledView className='flex-1 bg-white p-4 justify-between'>
            <StyledView>
                <StyledText className='text-[#204F50] text-xl font-poppi-bold'>Payment details</StyledText>
                ...
                <StyledView >
                    <StyledView className='gap-1 my-2'>
                        <StyledText className='text-sm text-[#7658F2] font-poppi-medium'>Card Number</StyledText>
                    ...
                    <StyledView className='flex-row justify-between'>
                        <StyledView className='w-1/2 pr-1'>
                            <StyledText className='text-sm text-[#7658F2] font-poppi-medium'>Expiration Date</StyledText>
                        ...
                        <StyledView className='w-1/2 pl-1'>
                            <StyledText className='text-sm text-[#7658F2] font-poppi-medium'>CVV Code</StyledText>
            ...
            <StyledTouchableOpacity onPress={() => setSubmitOpen(true)} className='rounded-[18px] bg-[#76F5A4] p-[10px] items-center'>
                <StyledText className='text-base text-[#204F50] font-poppi-semibold'>Add Card</StyledText>
            </StyledTouchableOpacity>
            {submitOpen && <SubmitOperationModal setModalOpen={setSubmitOpen} text="Would you like to save your card?" />}
        </StyledView>
    )
}
